...
import fr.lfml.manaproject.config.audit.AuditEventConverter;
import fr.lfml.manaproject.domain.PersistentAuditEvent;
...
import static fr.lfml.manaproject.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
